...
const Register = () => {
    ...
    const renderInfoPanel = () => {
        const content = [
            ...
            {
                title: "Review & Submit",
                desc: "Please review all your information carefully. Once submitted, you cannot change these details.",
                icon: CheckCircle
            },
            {
                title: "Your Secure Code",
                desc: "Save this unique code securely. You'll need it to login along with your CNIC and password.",
                icon: Shield
            }
        ][step];

        return (
            <div className="hidden lg:flex flex-col justify-center p-12 bg-indigo-600 text-white h-full rounded-r-2xl">
                <div className="bg-white/10 p-4 rounded-2xl w-16 h-16 flex items-center justify-center mb-6 backdrop-blur-sm">
